...
class LandRentPage extends StatefulWidget {
  @override
  _LandRentPageState createState() => _LandRentPageState();
}

class _LandRentPageState extends State<LandRentPage> {
  ...
  Future<void> _handleSubmit(PropertyFormData formData) async {
    ...
    try {
      ...
      await FirebaseFirestore.instance.collection('properties').add({
        ...
        'listingType': ListingType.rent.toString(),
        ...
        'rentalPeriod': formData.additionalDetails['rentalPeriod'] ?? '',
        'rentalTerms': formData.additionalDetails['rentalTerms'] ?? '',
      });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title:
            Text("List Land for Rent", style: TextStyle(color: Colors.black)),
        elevation: 0,
          ...
          child: Column(
            ...
            children: [
              ...
              PropertyForm(
                ...
                allowedListingTypes: [ListingType.rent],
                onSubmit: _handleSubmit,
                submitButtonText: 'List Land for Rent',
              ),
            ],
          ),
        ),
