...
class PropertySalePage extends StatefulWidget {
  @override
  _PropertySalePageState createState() => _PropertySalePageState();
}

class _PropertySalePageState extends State<PropertySalePage> {
  ...
  Future<void> _handleSubmit(PropertyFormData formData) async {
    ...
    try {
      ...
      await FirebaseFirestore.instance.collection('properties').add({
        ...
        'houseType': formData.propertyType == PropertyType.house
            ? formData.houseType?.toString()
            : null,
      });
          ...
          child: Column(
            ...
            children: [
              ...
              PropertyForm(
                ...
                submitButtonText: 'List Property for Sale',
              ),
            ],
          ),
        ),
